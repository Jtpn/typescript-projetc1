...
import { View, Text, FlatList, ActivityIndicator, StyleSheet, TextInput,
...
'center', marginBottom: 20 },
    ...
    inputBusca: { width: '100%', padding: 10, borderWidth: 1, borderColor: '#ccc',
borderRadius: 5, marginBottom: 15 },
    itemProduto: { flexDirection: 'row', padding: 15, borderWidth: 1, borderColor:
'#eee', borderRadius: 8, marginBottom: 10, alignItems: 'center' },
